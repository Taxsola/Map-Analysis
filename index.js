...
if (Message === '!ma tutorial'){
  ...
  text += "```Apache" + "\n"
  text += "!ma tutorial 1 -> Basic concepts." + "\n"
  text += "!ma tutorial 2 -> Tools." + "\n"
  text += "!ma tutorial 3 -> Coords on canvas." + "\n"
  text += "!ma tutorial 4 -> Text blocks." + "\n"
  text += "!ma tutorial 5 -> Identation." + "\n"
  text += "!ma tutorial 6 -> Props." + "\n"
